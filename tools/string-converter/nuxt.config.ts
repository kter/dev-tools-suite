export default defineNuxtConfig({
  ...
  app: {
    baseURL: '/',
    head: {
      title: 'String Converter - DevTools',
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { name: 'description', content: 'Convert strings between various formats: Base64, URL encoding, HTML escaping, case conversion and more' }
,
        {
